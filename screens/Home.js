  ...
  function renderNewSeasonSection() {
    return (
      <Animated.FlatList
        ...
        )} // getting horizontal scroll position and assign it to the newSeasonScrollX variable
        renderItem={({ item, index }) => {
          return (
            <TouchableWithoutFeedback
              onPress={() =>
                navigation.navigate("MovieDetail", { selectedMovie: item })
              } // navigate to movie detail screen and pass param
            >
              <View
                style={{
                  width: SIZES.width,
              ...
              <TouchableWithoutFeedback
                onPress={() =>
                  navigation.navigate("MovieDetail", {
                    selectedMovie: item, // to pass the item as parameter
                  })
                }
              >
                <View
